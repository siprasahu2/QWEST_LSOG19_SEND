...
[condition][]it is not true that Position {pos} of {field} field is equal to values {values}=(!((new Position()).positionOftagValueEqualToValues({pos},(xcb.xpath({field}).stringValue()),{values})))
